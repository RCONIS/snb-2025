...
- And then last year I co-founded RCONIS to  
  1. help Pharma companies to use new statistical methodology in R et al. reliably
...
- Focuses on 
  1. building packages together (already on CRAN are `mmrm`, `brms.mmrm`, `maicplus`)
...
- ["Good Software Engineering Practices for R Packages"](https://rconsortium.github.io/asa-biop-swe-wg/blog/2023-gswe4rp-workshops-wrapup/)
  ...
  - Including the short course here tomorrow afternoon
