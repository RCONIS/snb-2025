...
institute: "Keynote at SnB 2025"
date: "2025-10-09"
date-format: long
license: 'CC BY-SA'
format: 
  revealjs:
    logo: RCONIS_logo.png
    fontsize: 2rem
    slide-number: c/t
    toc: true
    toc-depth: 1
...
title-slide-attributes: 
  data-background-image: "RCONIS_logo.png"
...
Partly based on the manuscript "The Statistical Software Revolution in Pharmaceutical Development: Challenges and Opportunities in Open Source" ([arXiv](https://arxiv.org/abs/2301.11791)) which is joint work with:
...
- And Roche just started venturing more into R territory, so I built up the Statistical Engineering team there
- And then last year I co-founded [RCONIS](https://rconis.com) to  
  1. help Pharma companies to use (new) statistical methodology in R reliably
  2. be able to work remotely from Taiwan
...
- Do *not* think that programming is superfluous because of LLMs! You *still* need to be able to do it yourself to use LLMs efficiently and reliably!
...
- Started crowd-funding the development via [RPACT](https://rpact.com) in 2025
...
- ["Good Software Engineering Practices for R Packages"](https://rconsortium.github.io/asa-biop-swe-wg/blog/2023-gswe4rp-workshops-wrapup/)
  - `openstatsware` have run 12 workshops across the globe since 2023!
  - Including the short course here tomorrow afternoon - see you there!
...
These slides are at [RCONIS.github.io/snb-2025](https://RCONIS.github.io/snb-2025)
